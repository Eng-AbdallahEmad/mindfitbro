...
class PlansController extends Controller
{
    public function index()
    {
        ...
        $plansJson = $plans->keyBy('id')->map(fn ($p) => [
            ...
            'desc'          => $p->desc,
            'price'         => $p->price,
            'style_variant' => $p->style_variant ?? 'outline',
            'icon'          => $p->icon,
            'icon_bg'       => $p->icon_bg,
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'popular'       => 'boolean',
            'is_active'     => 'boolean',
            'style_variant' => 'required|in:outline,solid,accent',
            ...
            'style_variant.required' => 'شكل الزر مطلوب',
            'style_variant.in'       => 'شكل الزر غير صالح',
