...
<style>
    ...
    .input-wrap .auth-input { padding-left: 2.8rem; }
</style>
@endsection
        ...
        <div class="relative z-10 flex flex-col items-center gap-8">
            <div>
                <h2 class="font-display text-center text-3xl xl:text-5xl text-white font-black leading-tight mb-4">
                    خطوة واحدة،
                    <span class="text-accent">وترجع تاني</span>
                </h2>
                <p class="font-arabic text-center text-white/70 text-base leading-relaxed max-w-sm">
                    اختار كلمة سر جديدة قوية وعود لرحلتك الرياضية مع MindFitBro
                </p>
            </div>
            ...
            <div class="flex flex-col gap-4 w-full">
                <div class="stat-float flex items-center gap-4">
                    ...
                    <div class="font-arabic">
                        <p class="text-white font-black text-sm">كلمة سر جديدة وآمنة</p>
                        <p class="text-white/50 text-xs">استخدم مزيج من الأرقام والحروف</p>
                    </div>
                </div>
                <div class="stat-float flex items-center gap-4">
                    <div class="w-10 h-10 rounded-xl bg-accent/20 flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="font-arabic">
                        <p class="text-white font-black text-sm">حسابك محمي تماماً</p>
                        <p class="text-white/50 text-xs">الرابط صالح لمرة واحدة فقط</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="flex-1 bg-lightBg flex items-center justify-center p-6 lg:p-12 min-h-screen lg:min-h-0">
        ...
        <div class="auth-card w-full max-w-md">
            ...
            <form method="POST" action="{{ route('password.update') }}" class="flex flex-col gap-5" x-data="{ showPass: false, showConfirm: false }">
                ...
                {{-- New Password --}}
                <div class="flex flex-col gap-2">
                    <label for="password" class="text-sm font-black text-textColor font-arabic">كلمة السر الجديدة</label>
                    <div class="input-wrap">
                        <input
                            :type="showPass ? 'text' : 'password'"
                            name="password"
                            id="password"
                            placeholder="كلمة سر قوية (6 أحرف على الأقل)"
                            autofocus
                ...
                {{-- Confirm Password --}}
                <div class="flex flex-col gap-2">
                    <label for="password_confirmation" class="text-sm font-black text-textColor font-arabic">تأكيد كلمة السر</label>
                    <div class="input-wrap">
                        <input
