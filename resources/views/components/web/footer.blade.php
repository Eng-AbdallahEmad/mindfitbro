        ...
        <div class="grid grid-cols-1 md:grid-cols-2 {{ $hidden ? 'lg:grid-cols-3' : 'lg:grid-cols-4' }} gap-12">
            ...
            <div class="flex flex-col gap-5 font-arabic">
                ...
                <ul class="flex flex-col gap-4">
                    @foreach([
                        ...
                        ['name' => 'باقة العائلة', 'price' => '1,399', 'icon' => 'family_restroom'],
                    ] as $plan)
                    <li>
            ...
            <div class="flex flex-col gap-5 font-arabic">
                ...
                <div class="flex flex-col gap-3.5">
                    <a href="tel:+96650000000" class="group flex items-center gap-3 text-sm text-white/60 hover:text-white transition-colors duration-300">
